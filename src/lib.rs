...
pub use sandbox_test_macros::sandbox;
// pub use tool::SANDBOX_ADDR;
pub use tool::CURRENT_SANDBOX_PORT;
...
mod tests {
    ...
    #[test]
    fn test_nft_example() {
        // *tool::SANDBOX_ADDR.lock().unwrap() = "http://localhost:4080".to_owned();
